...
export async function generateMetadata({
  ...
  if (!slug || slug.length === 0) {
    const t = getDictionary(locale).docs.resourcesOverview;
...
function Overview({
  ...
  const t = dict.docs.resourcesOverview;
  const sidebarLabels = {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="mt-1.5 text-[13px] leading-relaxed text-muted-foreground">
                      {doc?.description ?? t.fallbackDescription}
                    </p>
                  </a>
                );
              })}
...
export default async function ResourcesPage({
  ...
  const sectionTitle =
    ...
    )?.title ?? dict.docs.resourcesOverview.title;
  ...
  return (
    <DocPageView
      ...
      breadcrumb={[
        ...
        {
          label: sectionTitle,
          href: `${localePrefix}/docs/resources`,
        },
        { label: doc.title },
      ]}
