  ...
  useEffect(() => {
    ...
    fetch("/api/invites/accept", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ token }) })
      .then(async (response) => {
        ...
        router.replace(`/dashboard/w/${data.workspaceId}`);
      })
