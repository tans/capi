    ...
    <div className="container-docs">
      <div className="grid gap-10 lg:grid-cols-[210px_minmax(0,1fr)]">
        ...
        <main className="min-w-0 py-8 lg:py-10">
          ...
          />
          <h1 className="display-1 mt-5 text-foreground">API Reference</h1>
          <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-muted-foreground">
            Every endpoint Capi exposes, grouped by capability. Each page
            documents the parameters, a runnable request, and the exact response
            shape.
          </p>
        ...
        <main className="min-w-0 py-8 lg:py-10">
          <DocsBreadcrumb
            items={[
              ...
              { label: endpoint.group, href: "/docs/api" },
            ]}
          />
          ...
          <div className="mt-5 flex flex-wrap items-start justify-between gap-5">
            ...
            <CopyPageActions slug={`api/${endpoint.slug}`} markdown={markdown} />
          </div>
          ...
          <div className="mt-10 grid items-start gap-10 xl:grid-cols-[minmax(0,1fr)_360px]">
            ...
            <div className="flex min-w-0 flex-col gap-10">
              <div>
                <SectionNumber n="01" title="Overview" />
              ...
              {endpoint.params.length > 0 ? (
                <div>
                  <SectionNumber n="02" title="Parameters" />
              ...
              {endpoint.notes && endpoint.notes.length > 0 ? (
                <div>
                  <SectionNumber n="04" title="Notes" />
          ...
          <div className="mt-16 flex flex-wrap gap-4 border-t border-border pt-8">
            {endpoint.group === "Task API" ? (
              <Link
                href="/docs/guides/task-api/quickstart"
