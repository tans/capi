...
export async function GET(request: Request) {
  ...
  const users = db.query<{ id: number; email: string; name: string; role: string; balance_units: number; spent_units: number; created_at: number; last_used_at: number | null }, []>(
