 ...
 description: "先从一个工作区开始,随着铺开再逐步加上 Key、预算和席位。",
  ...
  dashboard: {
    ...
    components: {
      ...
      keyManager: { createTitle: "创建 API 密钥", secretDescription: "密钥只显示一次，请妥善保存。", name: "名称", budget: "额度（USD，可选）", noLimit: "不限额", permissions: "权限", create: "创建密钥", secretTitle: "你的新密钥", secretOnce: "请立即复制，之后将无法再次显示。", copy: "复制", copied: "已复制", done: "完成", rotate: "轮换", revoke: "吊销", rotateConfirm: "轮换此密钥？旧密钥将停止工作。", revokeConfirm: "吊销此密钥？现有客户端将立即停止工作。", createError: "无法创建密钥", rotateError: "无法轮换密钥", revokeError: "无法吊销密钥" },
