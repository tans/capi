...
title: "把 CAPI 推到整个组织",
 description: "先从一个工作区开始,随着铺开再逐步加上 Key、预算和席位。",
  ...
  dashboard: {
    ...
    components: {
      nav: { usageAnalytics: "用量分析", securityAudit: "安全审计", routingSecurity: "路由与安全", members: "成员", billing: "账单", channels: "渠道", workspaceSettings: "工作区设置", workspace: "工作区", dashboard: "控制台", administrator: "管理员", openAdministrator: "进入管理员", backToWorkspace: "返回工作区", newWorkspace: "新建工作区" },
