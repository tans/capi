 ...
 description: "先从一个工作区开始,随着铺开再逐步加上 Key、预算和席位。",
  ...
  dashboard: {
    ...
    components: {
      ...
      channels: { defaultTitle: "CAPI 默认渠道", defaultDescription: "使用 CAPI 平台维护的默认模型服务，无需配置上游。", enable: "启用 CAPI 默认渠道", enabled: "已启用", disabled: "已停用", addTitle: "添加我的渠道", addDescription: "支持 DeepSeek、OpenAI 及其他官方 OpenAI 兼容服务。", namePlaceholder: "渠道名称，例如 DeepSeek", baseUrlPlaceholder: "上游地址，例如 https://api.deepseek.com", modelsPlaceholder: "模型列表，每行一个，例如 deepseek-chat\ndeepseek-reasoner", keysPlaceholder: "API Key，每行一个", saving: "保存中…", add: "添加渠道", updateError: "无法更新 CAPI 默认渠道", createError: "无法创建渠道" },
      channelActions: { channelName: "渠道名称", save: "保存", cancel: "取消", edit: "编辑", disable: "禁用", enable: "启用", delete: "删除", deleteConfirm: "删除此渠道？", updateError: "无法更新渠道" },
