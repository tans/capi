...
title: "Take CAPI across your organization",
 description: "Start with one workspace, then add keys, budgets, and seats as adoption grows.",
  ...
  dashboard: {
    ...
    components: {
      nav: { usageAnalytics: "Usage analytics", members: "Members", billing: "Billing", channels: "Channels", workspaceSettings: "Workspace settings", workspace: "Workspace", dashboard: "Dashboard", administrator: "Administrator", openAdministrator: "Open administrator", backToWorkspace: "Back to workspace", newWorkspace: "New workspace" },
      ...
      settings: { autoRoute: "Automatic routing", autoRouteDescription: "Configure models for tasks of different complexity; customize the name.", routeName: "Route name", modelSuffix: "model", saveAutoRoute: "Save automatic routing" },
      channelEditor: {
