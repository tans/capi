  ...
  dashboard: {
    ...
    workspace: {
      ...
      keys: {
        ...
        create: "Create key",
        creating: "Creating…",
        secretDescription: "Keys can be revealed and copied from the list below. Store them safely.",
        secretTitle: "Your new secret",
        secretOnce: "You can reveal it again later from the key list.",
        copy: "Copy",
        copied: "Copied",
        showSecret: "Show key",
        hideSecret: "Hide key",
    ...
    components: {
      nav: { usageAnalytics: "Usage analytics", securityAudit: "Security audit", routingSecurity: "Routing & security", members: "Members", billing: "Billing", channels: "Channels", workspaceSettings: "Workspace settings", workspace: "Workspace", dashboard: "Dashboard", administrator: "Administrator", openAdministrator: "Open administrator", backToWorkspace: "Back to workspace", newWorkspace: "New workspace" },
      ...
      settings: { autoRoute: "Automatic routing", autoRouteDescription: "Choose models by request type and complexity; use the name below as an API model alias.", routeName: "Route name", modelSuffix: "model", saveAutoRoute: "Save automatic routing", chat: "Chat", code: "Code", light: "Light", standard: "Standard", advanced: "Advanced", jevTitle: "JEV capabilities", jevDescription: "JEV is off by default; evaluation charges come from this workspace balance.", jevRoute: "JEV automatic routing", jevRouteDescription: "Analyze chat and code requests, then select a model using the profiles below. Low-confidence requests stay on the standard tier.", jevAudit: "JEV input security audit", jevAuditDescription: "Audits Chat and Responses inputs only. High-risk content is recorded and never blocks a request.", jevEnabled: "Enabled", jevDisabled: "Disabled", enableRoutingToConfigure: "Enable JEV automatic routing to configure the alias and model tiers.", openSecurityAudit: "Open routing & security", jevReadonly: "Only workspace owners and admins can change these settings.", jevSaved: "JEV settings saved", jevError: "Unable to save JEV settings" },
      security: { enabled: "Audit enabled", disabled: "Audit disabled", enabledDescription: "JEV audits Chat and Responses inputs only; model outputs are not stored.", disabledDescription: "JEV input security audit is not enabled for this workspace.", enableTitle: "Start recording high-risk inputs", enableDescription: "Auditing never blocks a request. High-risk items will appear below for workspace members to review.", enableAudit: "Enable input security audit", manageHint: "Ask a workspace owner or admin to enable it.", incidents: "Security incidents", incidentsDescription: "All members can see the list. Only owners and admins can expand evidence.", time: "Time", severity: "Severity", category: "Category", confidence: "Confidence", status: "Status", action: "Action", hide: "Hide", show: "Show", evidence: "Evidence", details: "Details", markCritical: "Mark critical", resolve: "Resolve", incidentsEmpty: "No security incidents recorded.", routeAnalysis: "Route analysis", routeEnabledDescription: "Recent JEV decisions are retained for 90 days; aggregates are retained longer.", routeDisabledDescription: "JEV automatic routing is disabled. Enable it to see recent routing decisions here.", configureRouting: "Configure automatic routing", intent: "Intent", complexity: "Complexity", security: "Security", requestText: "Request text", hidden: "Hidden", decisionsEmpty: "No JEV decisions recorded." },
      channelEditor: {
