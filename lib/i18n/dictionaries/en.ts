 ...
 description: "Start with one workspace, then add keys, budgets, and seats as adoption grows.",
  ...
  dashboard: {
    ...
    components: {
      ...
      channels: { defaultTitle: "CAPI default channel", defaultDescription: "Use the default model service maintained by CAPI without configuring an upstream.", enable: "Enable CAPI default channel", enabled: "Enabled", disabled: "Disabled", addTitle: "Add my channel", addDescription: "Supports DeepSeek, OpenAI, and other official OpenAI-compatible services.", namePlaceholder: "Channel name, e.g. DeepSeek", baseUrlPlaceholder: "Upstream URL, e.g. https://api.deepseek.com", modelsPlaceholder: "Model list, one per line, e.g. deepseek-chat\ndeepseek-reasoner", keysPlaceholder: "API keys, one per line", saving: "Saving…", add: "Add channel", updateError: "Unable to update CAPI default channel", createError: "Unable to create channel" },
      channelActions: { channelName: "Channel name", save: "Save", cancel: "Cancel", edit: "Edit", disable: "Disable", enable: "Enable", delete: "Delete", deleteConfirm: "Delete this channel?", updateError: "Unable to update channel" },
