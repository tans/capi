 ...
 description: "Start with one workspace, then add keys, budgets, and seats as adoption grows.",
  ...
  dashboard: {
    ...
    components: {
      ...
      keyManager: { createTitle: "Create an API key", secretDescription: "The secret appears once. Store it somewhere safe.", name: "Name", budget: "Budget (USD, optional)", noLimit: "No limit", permissions: "Permissions", create: "Create key", secretTitle: "Your new secret", secretOnce: "Copy it now. It cannot be shown again.", copy: "Copy", copied: "Copied", done: "Done", rotate: "Rotate", revoke: "Revoke", rotateConfirm: "Rotate this key? The old secret stops working.", revokeConfirm: "Revoke this key? Existing clients will stop working immediately.", createError: "Unable to create key", rotateError: "Unable to rotate key", revokeError: "Unable to revoke key" },
